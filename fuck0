...
inv_json = {"notes"=>"Thanks for your business.", "customer_id"=>"480266000000071001", "terms"=>"Alex Test 0"}.to_json
...
conn = connection
if(true)
conn.send(verb, path, credentials.merge({'JSONString' => inv_json}))
else
conn.put do |req|
req.url(path)
