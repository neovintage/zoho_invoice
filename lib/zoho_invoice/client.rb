...
inv_json = {"total"=>"0.0", "invoice_number"=>"INV-0010547", "balance"=>"0.0", "status"=>"paid", "notes"=>"Thanks for your business.", "customer_id"=>"480266000000071001", "terms"=>"Alex Test 7", "customer_name"=>"Alex Sherstinsky Test"}.to_json
