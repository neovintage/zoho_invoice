...
test_json = {"notes" => "Thanks for your business.","customer_id" => "480266000000071001","terms" => "Alex Test 7", "custom_fields" => [{"index" => "1","show_on_pdf" => "false","value" => "52605","label" => "Customer ID"},{"index" => "2","show_on_pdf" => "false","value" => "no"},{"index" => "3","show_on_pdf" => "false","value" => "true"}]}.to_json
